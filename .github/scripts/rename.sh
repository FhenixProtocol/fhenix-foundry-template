...
# Rename instances of "fhenixprotocol/fhenix-foundry-template" to the new repo name in README.md for badges only
sedi "/gitpod/ s|fhenixprotocol/fhenix-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gitpod-badge/ s|fhenixprotocol/fhenix-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha/ s|fhenixprotocol/fhenix-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha-badge/ s|fhenixprotocol/fhenix-foundry-template|"${GITHUB_REPOSITORY}"|;" "README.md"
